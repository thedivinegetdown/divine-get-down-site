        ...
        <TabPanel id="welcome" heading="Welcome">
          <section className="panel-block">
            ...
            <p className="panel-lede">
              If you’ve been carrying weight you can’t explain—this space is for you.
              Watch the latest message, subscribe for weekly encouragement, and start with the Stillness Scroll.
            </p>
            ...
            <div className="bottom-cta">
              ...
              <p>New faith-filled uploads + Shorts designed to reset your mind and feed your spirit.</p>
      ...
      {activeTab === 'start' && (
        <TabPanel id="start" heading="Start Here">
          <section className="panel-block">
            ...
            <p className="panel-lede">
              If life feels loud, start here. A simple, faith-filled reset you can return to whenever you need peace.
            </p>
