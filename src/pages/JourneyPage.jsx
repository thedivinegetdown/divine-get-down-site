...
function JourneyPage() {
  return (
    <div className="App">
      <Helmet>
        <title>The Divine Get Down — 4-Week Journey</title>
        <meta
          name="description"
          content="A guided return to stillness, presence, and divine rhythm. A four-week sacred journey anchored in scripture, prayer, breath, and gentle movement."
        />
      </Helmet>
