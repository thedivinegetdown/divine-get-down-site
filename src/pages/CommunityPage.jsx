...
function CommunityPage() {
  return (
    <div className="App">
      <Helmet>
        <title>The Inner Rhythm — The Divine Get Down</title>
        <meta
          name="description"
          content="A gentle community for shared prayer, weekly guidance, and collective stillness. Community is not obligation — it is shared presence."
        />
      </Helmet>
