...
function StillnessScrollPage() {
  return (
    <div className="App">
      <Helmet>
        <title>Receive the Stillness Scroll — The Divine Get Down</title>
        <meta
          name="description"
          content="A sacred scroll for the weary soul — a quiet moment of prayer, breath, and scripture to help you release what you’ve been carrying."
        />
      </Helmet>
